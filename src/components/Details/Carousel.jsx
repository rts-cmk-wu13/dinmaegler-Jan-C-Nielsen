...
export default function Carousel({ product }) {
    ...
    const images = product.floorplanPresent ? [product.floorplan.url] : product.images.map(img => img.url);
    console.log(images);
        ...
        <>
            <section className="carousel overlay">
                ...
                {!product.floorplanPresent && (
                    ...
                    || <section className="carousel__dots"></section>}
            </section>
        </>
    )
}